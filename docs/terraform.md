...
| <a name="input_attributes"></a> [attributes](#input\_attributes) | Additional attributes (e.g. `policy` or `role`) | `list` | `[]` | no |
...
| <a name="input_eni_ids"></a> [eni\_ids](#input\_eni\_ids) | IDs of ENIs | `list` | `[]` | no |
...
| <a name="input_subnet_ids"></a> [subnet\_ids](#input\_subnet\_ids) | IDs of subnets | `list` | `[]` | no |
